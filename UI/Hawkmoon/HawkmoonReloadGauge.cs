...
{
	internal class HawkmoonReloadGauge : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/Hawkmoon/HawkmoonReloadGauge"));
			...
			colorB = new Color(205, 100, 50); // Good
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			if (modPlayer.hawkmoonReloadTimer > 85 && modPlayer.hawkmoonReloadTimer < 100)
			{
				UsedColor = colorB;
			}
			else
