...
{
	internal class PowderGauge : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/PowderGaugeFrame"));
			...
			bulletIndicator = new UIImage(Request<Texture2D>("StarsAbove/UI/PowderGaugeIndicatorOff"));
			bulletIndicator.Left.Set(62 , 0f);
			bulletIndicator.Top.Set(0, 0f);
			bulletIndicator.Width.Set(40, 0f);
			bulletIndicator.Height.Set(40, 0f);
		...
		public override void Draw(SpriteBatch spriteBatch) {
			...
			if (!(Main.LocalPlayer.HeldItem.ModItem is KroniicAccelerator))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			for (int i = 0; i < steps; i += 1) {
                ...
                {
					spriteBatch.Draw(TextureAssets.MagicPixel.Value, new Rectangle(left + i, hitbox.Y, 1, hitbox.Height), finalColor);
