...
{
    internal class PolluxCastBar : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/PolluxCastBar"));
			...
			gradientB = new Color(56, 246, 249); //
		...
		public override void Draw(SpriteBatch spriteBatch) {
			...
			if (modPlayer.PolluxBarActive == false)
				return;
