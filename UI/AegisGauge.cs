...
{
	internal class AegisGauge : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/AegisGauge"));
		...
		public override void Draw(SpriteBatch spriteBatch) {
			if (!(Main.LocalPlayer.HeldItem.ModItem is AegisDriver))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			// Calculate quotient
			float quotient = (float)modPlayer.aegisGauge / 100; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
