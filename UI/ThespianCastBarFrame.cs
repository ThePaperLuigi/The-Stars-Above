...
{
    internal class ThespianCastBar : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/ThespianCastBarFrame"));
		...
		public override void Draw(SpriteBatch spriteBatch) {
			...
			if (modPlayer.ThespianBarActive == false)
				return;
		...
		public override void Update(GameTime gameTime) {
			...
			text.SetText($"[c/F4D5EF:{modPlayer.NextAttack} ]");
	...
	/* internal class VagrantCastBar : UIState
	{
		// For this bar we'll be using a frame texture and then a gradient inside bar, as it's one of the more simpler approaches while still looking decent.
		// Once this is all set up make sure to go and do the required stuff for most UI's in the Mod class.
		private UIText text;
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(Request<Texture2D>("StarsAbove/UI/VagrantCastBarFrame"));
			barFrame.Left.Set(22, 0f);
			barFrame.Top.Set(0, 0f);
			barFrame.Width.Set(138, 0f);
			barFrame.Height.Set(34, 0f);
