...
{
    internal class TwoCrownBowGauge : UIState
	{
		...
		public override void Draw(SpriteBatch spriteBatch) {
			if (!(Main.LocalPlayer.HeldItem.ModItem is TwoCrownBow))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			// Calculate quotient
			float quotient = (float)modPlayer.terminationGauge / (float)100; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
			...
			spriteBatch.Draw((Texture2D)Request<Texture2D>("StarsAbove/UI/TwoCrownBowGauge"), barFrame.GetInnerDimensions().ToRectangle(), Color.White);
