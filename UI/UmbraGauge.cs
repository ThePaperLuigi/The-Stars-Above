...
{
    internal class UmbraGauge : UIState
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			spriteBatch.Draw((Texture2D)Request<Texture2D>("StarsAbove/UI/UmbraGauge"), barFrame.GetInnerDimensions().ToRectangle(), Color.White);
