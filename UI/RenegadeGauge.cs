...
{
    internal class RenegadeGauge : UIState
	{
		...
		public override void OnInitialize() {
			...
			gradientA = new Color(249, 214, 144); // 
			gradientB = new Color(255, 185, 44); //
			finalColor = new Color(255, 131, 0);
		...
		public override void Draw(SpriteBatch spriteBatch) {
			if (!(Main.LocalPlayer.HeldItem.ModItem is ElCapitansHardware))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			// Calculate quotient
			float quotient = (float)modPlayer.renegadeGauge / 100; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
