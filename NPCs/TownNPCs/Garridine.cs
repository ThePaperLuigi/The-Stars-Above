...
namespace StarsAbove.NPCs.TownNPCs
{
    ...
    public class Garridine : ModNPC
	{
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.AttackAverageChance[Type] = 8888;
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.StarsAbove.Bestiary.Garridine")
			});
		}
        ...
        public override void HitEffect(NPC.HitInfo hit)
		{
            ...
            {
				NPC.active = false;
				if (Main.netMode != NetmodeID.Server && Main.myPlayer == Main.LocalPlayer.whoAmI) { Main.NewText(LangHelper.GetTextValue($"NPCDialogue.Garridine.Leaving"), 255, 126, 114); }
		...
		public override string GetChat()
		{
			...
			chat.Add(LangHelper.GetTextValue("NPCDialogue.Garridine.1"));
			chat.Add(LangHelper.GetTextValue("NPCDialogue.Garridine.2"));
			chat.Add(LangHelper.GetTextValue("NPCDialogue.Garridine.3"));
			chat.Add(LangHelper.GetTextValue("NPCDialogue.Garridine.4"));
		...
		{ // What the chat buttons are when you open up the chat UI
			...
			button2 = LangHelper.GetTextValue("NPCDialogue.Quest");
		}
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shopName)
		{
			if (firstButton)
			{
				//Play the VN dialogue. Garridine will quip about random story relevant bits, and then give you bounty hunting pointers, granting a buff.
