...
namespace StarsAbove.Tiles.StellarSpoils
{
	...
	public class ReprintedBlueprintTile : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/StellarSpoils/ReprintedBlueprintTile";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.ReprintedBlueprint>();
					break;
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
			if (closer)
			{
				var modPlayer = Main.LocalPlayer.GetModPlayer<ReprintedBlueprintPlayer>();
				modPlayer.nearBlueprint = true;
			}
        }
	...
	public class ReprintedBlueprintPlayer : ModPlayer
    {
		public bool nearBlueprint;
        public override void PreUpdate()
        {
			if(nearBlueprint && Player.velocity == Vector2.Zero)
            {
