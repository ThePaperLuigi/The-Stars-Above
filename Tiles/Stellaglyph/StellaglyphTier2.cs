...
namespace StarsAbove.Tiles.Stellaglyph
{
	...
	public class StellaglyphTier2 : ModTile
	{
		...
		public override string Texture => "StarsAbove/Tiles/Stellaglyph/StellaglyphTier2Base";
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				modPlayer.stellaglyphTier = 2;
				modPlayer.stellarFociMax = 8;
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("StellaglyphTier2").Type;
		}
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			int itemType = ModContent.ItemType<Items.Placeable.Stellaglyphs.StellaglyphTier2>();
			switch (placeStyle)
			{
				case 0:
