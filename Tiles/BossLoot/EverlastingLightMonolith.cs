...
namespace StarsAbove.Tiles.BossLoot
{
    ...
    public class EverlastingLightMonolith : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/EverlastingLightMonolith";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "StarsAbove/Tiles/BossLoot/Empty";
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(233, 207, 94), Language.GetText("MapObject.Monolith"));
		}
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.BossLoot.SparkOfLuminance>();
					break;
