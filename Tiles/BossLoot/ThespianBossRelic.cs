...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class ThespianBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/ThespianBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
            ...
            int itemType = ModContent.ItemType<Items.Placeable.BossLoot.ThespianBossRelicItem>();
