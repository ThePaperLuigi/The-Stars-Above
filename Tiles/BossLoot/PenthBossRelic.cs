...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class PenthBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/PenthBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
            ...
            int itemType = ModContent.ItemType<Items.Placeable.BossLoot.PenthBossRelicItem>();
