...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class VagrantBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/VagrantBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.BossLoot.VagrantBossRelicItem>();
					break;
