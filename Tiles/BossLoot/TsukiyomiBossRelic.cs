...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class TsukiyomiBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/TsukiyomiBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "StarsAbove/Tiles/BossLoot/RelicPedestal";
		...
		public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Draw(texture, drawPos, frame, color, (float)Math.Sin(Main.GlobalTimeWrappedHourly * TwoPi / 2f) * 0.3f + 0.7f, origin, 1f, effects, 0f);
