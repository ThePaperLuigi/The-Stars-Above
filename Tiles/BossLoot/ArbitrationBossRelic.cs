...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class ArbitrationBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/ArbitrationBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
            ...
            int itemType = ModContent.ItemType<Items.Placeable.BossLoot.ArbitrationBossRelicItem>();
