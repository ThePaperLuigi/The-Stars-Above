...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class DioskouroiBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/DioskouroiBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
            ...
            int itemType = ModContent.ItemType<Items.Placeable.BossLoot.DioskouroiBossRelicItem>();
