...
namespace StarsAbove.Tiles.BossLoot
{
	...
	public class NalhaunBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/BossLoot/NalhaunBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.BossLoot.NalhaunBossRelicItem>();
					break;
