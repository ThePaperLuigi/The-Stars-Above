...
namespace StarsAbove.Tiles.CyberWorld
{
    ...
    {
        public static LocalizedText OrePassMessage { get; private set; }

        public override void SetStaticDefaults()
        {
            OrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(OrePassMessage)}");
        }
    ...
    public class ExampleOrePass : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = OreGeneration.OrePassMessage.Value;
            ...
            for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
            {
                ...
                WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<CorundumOre>());
