...
namespace StarsAbove.Tiles.CyberWorld.Monolith
{
    public class NeonVeilReplicaMonolith : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/CyberWorld/Monolith/NeonVeilReplicaMonolithEffect";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "StarsAbove/Tiles/CyberWorld/Monolith/NeonVeilReplicaMonolith";
        public override void NearbyEffects(int i, int j, bool closer)
        {
            var modPlayer = Main.LocalPlayer.GetModPlayer<StarsAbovePlayer>();
            modPlayer.NeonVeilReplicaActive = true;
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = Mod.Find<ModItem>("NeonVeilReplicaMonolithItem").Type;
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 worldPos = p.ToWorldCoordinates(24f, 164f);
