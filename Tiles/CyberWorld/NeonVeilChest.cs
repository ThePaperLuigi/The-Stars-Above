...
{
    public class NeonVeilChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<NeonVeilChestItem>(), 1);
		...
		*/
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    ...
                    int key = ModContent.ItemType<NeonVeilChestKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<NeonVeilChestItem>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                    {
                        player.cursorItemIconID = ModContent.ItemType<NeonVeilChestKey>();
                    }
