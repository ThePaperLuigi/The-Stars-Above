...
namespace StarsAbove.Tiles.CyberWorld
{
	...
	public class HologramPlinthBigTreeTile : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/CyberWorld/HologramPlinthBigTree";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			int itemType = 0;
            itemType = ModContent.ItemType<HologramPlinthBigTree>();
