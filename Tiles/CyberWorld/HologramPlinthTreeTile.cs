...
namespace StarsAbove.Tiles.CyberWorld
{
	...
	public class HologramPlinthTreeTile : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Tiles/CyberWorld/HologramPlinthTree";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			int itemType = 0;
            itemType = ModContent.ItemType<HologramPlinthTree>();
