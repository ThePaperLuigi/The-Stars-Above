...
namespace StarsAbove.Tiles.CyberWorld
{
    ...
    public class GarridineNPCTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/CyberWorld/GarridineNPCTile";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "StarsAbove/Tiles/CyberWorld/HologramPlinthSmall";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = 0;
            itemType = ModContent.ItemType<HologramPlinthDrink>();
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            float offset = (float)Math.Sin(Main.GlobalTimeWrappedHourly * TwoPi / 6f);
            Vector2 drawPos = worldPos + offScreen - Main.screenPosition + new Vector2(0f, -70f) + new Vector2(0f, offset * 4f);
