...
namespace StarsAbove.Tiles.CyberWorld.Confluxes
{
	...
	public class ConfluxLuminousHallow : ModTile
	{
		...
		public virtual string RelicTextureName => "StarsAbove/Items/Prisms/LuminousHallowPrism";
        ...
        public override bool RightClick(int i, int j)
        {
            if(Main.LocalPlayer.GetModPlayer<StarsAbovePlayer>().hardlight >= 100)
            {
                ...
                Main.LocalPlayer.QuickSpawnItem(Main.LocalPlayer.GetSource_GiftOrReward(), ModContent.ItemType<LuminousHallowPrism>());
