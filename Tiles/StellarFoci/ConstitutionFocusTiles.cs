...
namespace StarsAbove.Tiles.StellarFoci
{
    ...
    public class ConstitutionFocusTier1Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/StellarFoci/Amethyst";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "StarsAbove/Tiles/StellarFoci/Tier1Base";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ConstitutionFocusTier1>();
            switch (placeStyle)
            {
                case 0:
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 drawPos = worldPos + offScreen - Main.screenPosition + new Vector2(0f, -20f) + new Vector2(0f, offset * 4f);
    ...
    public class ConstitutionFocusTier2Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "StarsAbove/Tiles/StellarFoci/Tier2Base";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ConstitutionFocusTier2>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            const float TwoPi = (float)Math.PI * 2f;
            float offset = (float)Math.Sin(Main.GlobalTimeWrappedHourly * TwoPi / 5f);
            Vector2 drawPos = worldPos + offScreen - Main.screenPosition + new Vector2(0f, -30f) + new Vector2(0f, offset * 4f);
    ...
    public class ConstitutionFocusTier3Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "StarsAbove/Tiles/StellarFoci/Tier3Base";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ConstitutionFocusTier3>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
