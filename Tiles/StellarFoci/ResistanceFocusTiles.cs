...
namespace StarsAbove.Tiles.StellarFoci
{
    ...
    public class ResistanceFocusTier1Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/StellarFoci/Sapphire";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ResistanceFocusTier1>();
            switch (placeStyle)
            {
                case 0:
...
//                Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, itemType);
    ...
    public class ResistanceFocusTier2Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ResistanceFocusTier2>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
...
//                Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, itemType);
    ...
    public class ResistanceFocusTier3Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.ResistanceFocusTier3>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
