...
namespace StarsAbove.Tiles.StellarFoci
{
    ...
    public class AgilityFocusTier1Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/StellarFoci/Emerald";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.AgilityFocusTier1>();
            switch (placeStyle)
            {
                case 0:
    ...
    public class AgilityFocusTier2Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.AgilityFocusTier2>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
    ...
    public class AgilityFocusTier3Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.AgilityFocusTier3>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
