...
namespace StarsAbove.Tiles.StellarFoci
{
    ...
    public class WealthFocusTier1Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "StarsAbove/Tiles/StellarFoci/Topaz";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.WealthFocusTier1>();
            switch (placeStyle)
            {
                case 0:
    ...
    public class WealthFocusTier2Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.WealthFocusTier2>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
    ...
    public class WealthFocusTier3Tile : ModTile
    {
        public const int FrameWidth = 18 * 3;
        public const int FrameHeight = 18 * 4;
        public const int HorizontalFrames = 1;
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = ModContent.ItemType<Items.Placeable.StellarFoci.WealthFocusTier3>();
            switch (placeStyle)
            {
                case 0:
                    //itemType = ModContent.ItemType<Items.Placeable.CelestriadRoot>();
