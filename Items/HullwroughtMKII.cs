        ...
        public override void HoldItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                else
                {
                    ...
                    if (player.GetModPlayer<WeaponPlayer>().bowCharge >= 100 && form == 2)//Fully Charged Mystic
                    {
                        player.GetModPlayer<WeaponPlayer>().bowChargeActive = false;
                        player.GetModPlayer<WeaponPlayer>().bowCharge = 0;
                    ...
                    {
                        if (player.GetModPlayer<WeaponPlayer>().bowCharge > 0 && form == 2)//Not Fully Charged Mystic
                        {//
                         //Main.PlaySound(SoundID.Item1, player.position);
                            player.GetModPlayer<WeaponPlayer>().bowChargeActive = false;
                            player.GetModPlayer<WeaponPlayer>().bowCharge = 0;
