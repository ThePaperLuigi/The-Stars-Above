...
{
	public class DioskouroiBossRelicItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Dioskouroi Relic");
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.BossLoot.DioskouroiBossRelic>(), 0);
