...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class LuckFocusTier1 : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Luck Focus (Tier 1)");
			

			/* Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases luck by 4% during a Cosmic Voyage" +
				""); */
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.LuckFocusTier1Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
