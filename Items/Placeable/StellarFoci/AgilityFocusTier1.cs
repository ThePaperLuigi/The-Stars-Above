...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class AgilityFocusTier1 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Agility Focus (Tier 1)");
			

			Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases movement speed by 3% during a Cosmic Voyage" +
				"");
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.AgilityFocusTier1Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
