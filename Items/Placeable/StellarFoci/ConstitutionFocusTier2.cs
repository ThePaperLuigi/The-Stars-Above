...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class ConstitutionFocusTier2 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Constitution Focus (Tier 2)");
			

			Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases Max HP by 8 and Max MP by 16 during a Cosmic Voyage" +
				"");
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.ConstitutionFocusTier2Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<ConstitutionFocusTier1>(), 1)
