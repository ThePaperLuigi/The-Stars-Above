...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class WealthFocusTier1 : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Wealth Focus (Tier 1)");
			

			/* Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases money dropped by foes by 7 silver during a Cosmic Voyage" +
				""); */
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.WealthFocusTier1Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
