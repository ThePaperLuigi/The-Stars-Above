...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class ResistanceFocusTier2 : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Resistance Focus (Tier 2)");
			

			/* Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases defense by 5 during a Cosmic Voyage" +
				""); */
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.ResistanceFocusTier2Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<ResistanceFocusTier1>(), 1)
