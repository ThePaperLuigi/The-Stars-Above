...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class AgilityFocusTier3 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.AgilityFocusTier3Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<AgilityFocusTier2>(), 1)
