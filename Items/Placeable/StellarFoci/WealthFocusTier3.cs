...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class WealthFocusTier3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Wealth Focus (Tier 3)");
			

			Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases money dropped by foes by 30 silver during a Cosmic Voyage" +
				"");
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.WealthFocusTier3Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<WealthFocusTier2>(), 1)
