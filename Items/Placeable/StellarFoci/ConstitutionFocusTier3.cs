...
namespace StarsAbove.Items.Placeable.StellarFoci
{
    ...
    public class ConstitutionFocusTier3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Constitution Focus (Tier 3)");
			

			Tooltip.SetDefault("" +
				"[c/FF1B8D:Stellar Foci]" +
				"\nOnce placed near a Stellaglyph:" +
				"\nIncreases Max HP by 12 and Max Mana by 24 during a Cosmic Voyage" +
				"");
			//
			//
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.StellarFoci.ConstitutionFocusTier3Tile>();	
			Item.useTurn = true;
			Item.width = 20;
			Item.height = 20;
			Item.maxStack = 1;
		...
		{
			CreateRecipe(1)
				.AddIngredient(ModContent.ItemType<StellarFocusBaseTier3>(), 1)
				.AddIngredient(ModContent.ItemType<ConstitutionFocusTier2>(), 1)
