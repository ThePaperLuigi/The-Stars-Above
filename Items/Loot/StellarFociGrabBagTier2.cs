...
namespace StarsAbove.Items.Loot
{
    ...
    public class StellarFociGrabBagTier2 : ModItem
	{
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Stellar Foci Grab Bag (Tier 2)");
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<StellarFociGrabBagTier3>(), 10, 1, 1)).
				OnFailedRoll(ItemDropRule.OneFromOptionsNotScalingWithLuck(1,
				ModContent.ItemType<AgilityFocusTier2>(),
				ModContent.ItemType<ConstitutionFocusTier2>(),
				ModContent.ItemType<LuckFocusTier2>(),
				ModContent.ItemType<PowerFocusTier2>(),
				ModContent.ItemType<ResistanceFocusTier2>(),
				ModContent.ItemType<WealthFocusTier2>()));
