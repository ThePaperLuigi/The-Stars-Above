...
namespace StarsAbove.Items.Loot
{
    ...
    public class StellarFociGrabBagTier3 : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(ItemDropRule.OneFromOptionsNotScalingWithLuck(1,
				ModContent.ItemType<AgilityFocusTier3>(),
				ModContent.ItemType<ConstitutionFocusTier3>(),
				ModContent.ItemType<LuckFocusTier3>(),
				ModContent.ItemType<PowerFocusTier3>(),
				ModContent.ItemType<ResistanceFocusTier3>(),
				ModContent.ItemType<WealthFocusTier3>()));
