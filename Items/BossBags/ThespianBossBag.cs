...
namespace StarsAbove.Items.BossBags
{
	...
	public class ThespianBossBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<NetheriteBar>(), 4, 1, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<ElectricGuitarPick>(), 4, 1, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<BottledChaos>(), 4, 1, 1));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<ThespianBoss>()));
		}
