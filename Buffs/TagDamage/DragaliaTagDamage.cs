...
{
    public class DragaliaTagDamage : ModBuff
    {
		...
		{
			npc.GetGlobalNPC<DragaliaDebuffNPC>().marked = true;
		}
	}

	public class DragaliaDebuffNPC : GlobalNPC
	{
		...
		public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
		{
			...
			{
				modifiers.SourceDamage += (player.maxMinions * 0.01f);
			}
		}
	}
}
