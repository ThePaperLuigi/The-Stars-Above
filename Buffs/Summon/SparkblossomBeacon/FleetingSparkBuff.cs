...
namespace StarsAbove.Buffs.Summon.SparkblossomBeacon
{
    public class FleetingSparkBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.SparkblossomBeacon.FleetingSparkMinion>()] > 0)
            {
