...
namespace StarsAbove.Systems
{
    ...
    public class DiskDialogueNotification : IInGameNotification
    {
        ...
        private Asset<Texture2D> iconTexture = ModContent.Request<Texture2D>($"StarsAbove/Items/Consumables/SpatialDiskStatic");
    ...
    public class ArrayAbilityNotification : IInGameNotification
    {
        // Remove this notification once the 5-second timer is up.
        public bool ShouldBeRemoved => timeLeft <= 0;
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            string title = LangHelper.GetTextValue("Common.ArrayAbility");
    ...
    public class NewNovaNotification : IInGameNotification
    {
        // Remove this notification once the 5-second timer is up.
        public bool ShouldBeRemoved => timeLeft <= 0;
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            string title = LangHelper.GetTextValue("Common.NewNova");
    ...
    public class Credits : IInGameNotification
    {
        // Remove this notification once the 5-second timer is up.
        public bool ShouldBeRemoved => timeLeft <= 0;
        ...
        private float Scale
        {
            get
            {
                ...
                if (timeLeft > 1170)
                {
                    return MathHelper.Lerp(1f, 0f, (timeLeft - 1170) / 15f);
                }
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            string title = LangHelper.GetTextValue("Common.Credits");
            ...
            float effectiveScale = Scale * 1.3f;
            Vector2 size = (FontAssets.ItemStack.Value.MeasureString(title) + new Vector2(58f, 10f)) * effectiveScale;
            Rectangle panelSize = Utils.CenteredRectangle(bottomAnchorPosition + new Vector2(0f, (0f - size.Y) * 0.5f), size);
        ...
        public void PushAnchor(ref Vector2 positionAnchorBottom)
        {
            ...
            // This is because notifications visually stack. In our case, we want to let other notifications
            // go in front of ours once we start fading off, so we scale the offset based on opacity.
            positionAnchorBottom.Y -= 250f * Opacity;
        }
    }
}