...
namespace StarsAbove.Systems
{
    ...
    public class ChionicDamageClass : DamageClass
    {
        ...
        public new string DisplayName => "Chionic Damage";
        ...
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
        {
            ...
            return new StatInheritanceData(
                ...
                critChanceInheritance: 1.2f,
                attackSpeedInheritance: 1.2f,
                armorPenInheritance: 1.2f,
                knockbackInheritance: 1.2f
            );
