...
namespace StarsAbove.Systems
{
    ...
    public class AuricDamageClass : DamageClass
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("auric damage");
		}

		//public string "Spatial Damage" => DisplayName;

		public new string DisplayName => "Auric Damage";
		...
		public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
		{
			...
			if (damageClass == DamageClass.Melee || damageClass == DamageClass.Magic)
