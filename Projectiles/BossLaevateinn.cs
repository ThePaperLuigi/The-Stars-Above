...
namespace StarsAbove.Projectiles
{
	public class BossLaevateinn : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center, Vector2.Zero, ProjectileType<BossLaevateinnDamage>(), 540, 0f, Projectile.owner, 0f, 0f);
