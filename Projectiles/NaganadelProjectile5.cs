...
namespace StarsAbove.Projectiles
{
    public class NaganadelProjectile5 : ModProjectile
	{
		...
		public override void AI() {
			...
			if (projOwner.GetModPlayer<StarsAbovePlayer>().naganadelWeapon5Summoned == false) {
				if (Projectile.owner == Main.myPlayer)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.position.X + (Projectile.width / 2), Projectile.position.Y + (Projectile.height / 2), (Main.MouseWorld).ToRotation(), (Main.MouseWorld).ToRotation(), ProjectileType<NaganadelProjectileFinal5>(), (int)(Projectile.damage * 10), 0f, Projectile.owner, 0f, 0f);
