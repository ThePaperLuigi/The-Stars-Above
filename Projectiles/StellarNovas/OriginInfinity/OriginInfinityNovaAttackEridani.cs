...
{
	public class OriginInfinityNovaAttackEridani : ModProjectile
	{
        ...
        void TryDamageInvincibleNPC()
        {
            ...
            for (int i = 0; i < Main.maxNPCs; i++)
            {
                ...
                if (npc.active && npc.Distance(Projectile.Center) < 150 && npc.dontTakeDamage)
                {
                    ...
                    npc.AddBuff(BuffType<NovaChainAttackEridani>(), (int)((player.novaEffectDuration + player.novaEffectDurationMod) * 60));
