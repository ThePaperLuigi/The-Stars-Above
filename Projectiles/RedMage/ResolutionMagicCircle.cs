...
namespace StarsAbove.Projectiles.RedMage
{
	public class ResolutionMagicCircle: ModProjectile
	{
		...
		public override void AI()			
		{
			...
			if (Projectile.ai[0] > 60)
			{
				...
				for (int d = 0; d < 35; d++)
				{
					...
					int dustIndex = Dust.NewDust(player.Center, 0, 0, DustID.FireworkFountain_Red, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 1f);
				...
				for (int d = 0; d < 35; d++)
				{
					...
					int dustIndex = Dust.NewDust(player.Center, 0, 0, DustID.FireworkFountain_Green, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 1f);
					Main.dust[dustIndex].noGravity = true;
				}
				for (int d = 0; d < 45; d++)
				{
					...
					int dustIndex = Dust.NewDust(player.Center, 0, 0, DustID.LifeDrain, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 2f);
					Main.dust[dustIndex].noGravity = true;
				}
        ...
        public override void Kill(int timeLeft)
        {
			...
			for (int d = 0; d < 12; d++)
			{
				Dust.NewDust(Projectile.Center, 0, 0, DustID.LifeDrain, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5), 150, default(Color), 0.7f);
