...
{
    public class DuckHuntDogPet : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			
			//DrawOffsetX = -20;
			// DisplayName.SetDefault("Duck Hunt Dog"); // Automatic from .lang files
		...
		public override void AI()
		{
			...
			if (player.dead)
			{
				modPlayer.DuckHuntDogPet = false;
			}
			if (modPlayer.DuckHuntDogPet)
			{
