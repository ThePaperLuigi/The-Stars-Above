...
{
    public class SpectralArsenalProjectile2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if(player.GetModPlayer<StarsAbovePlayer>().SpectralArsenal == 2)
            {
				Projectile.rotation = MathHelper.ToRadians(player.GetModPlayer<StarsAbovePlayer>().DaemonGlobalRotation) + MathHelper.ToRadians(45);
			}
			else
            {
				Projectile.rotation = MathHelper.ToRadians(player.GetModPlayer<StarsAbovePlayer>().DaemonGlobalRotation) + MathHelper.ToRadians(30);
