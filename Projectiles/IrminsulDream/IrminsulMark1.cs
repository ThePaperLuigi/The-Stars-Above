...
{
    public class IrminsulMark1 : ModProjectile
	{
        ...
        public override void AI()
		{
			...
			Projectile.position.X = player.GetModPlayer<StarsAbovePlayer>().IrminsulBoxStart.X - 17;
			Projectile.position.Y = player.GetModPlayer<StarsAbovePlayer>().IrminsulBoxStart.Y - 17;
