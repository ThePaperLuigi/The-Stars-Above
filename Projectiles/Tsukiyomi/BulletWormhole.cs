...
{
    public class BulletWormhole : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Projectile.ai[0] >= 20)
            {
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * Speed2) * -1), (float)((Math.Sin(Projectile.rotation) * Speed2) * -1), ProjectileID.PhantasmalBolt, 30, 0f, 0);
