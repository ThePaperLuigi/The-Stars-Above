...
{
    public class BulletWormhole2 : ModProjectile
	{
		...
		public override void AI() {
            ...
            {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * Speed) * -1), (float)((Math.Sin(Projectile.rotation) * Speed) * -1), ProjectileID.BrainScramblerBolt, 30, 0f, 0);
				Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * Speed2) * -1), (float)((Math.Sin(Projectile.rotation) * Speed2) * -1), ProjectileID.BrainScramblerBolt, 30, 0f, 0);
