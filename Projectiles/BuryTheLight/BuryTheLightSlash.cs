...
{
    public class BuryTheLightSlash : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Projectile.ai[0] == 1)
			{
				...
				for (int d = 0; d < 2; d++)
				{
					...
					int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, DustID.Electric, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 1f);;
