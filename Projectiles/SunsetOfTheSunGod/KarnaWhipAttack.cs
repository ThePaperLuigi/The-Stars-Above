...
{
	public class KarnaWhipAttack : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (int i = 0; i < list.Count - 1; i++)
			{
				...
				Rectangle frame = new Rectangle(0, 0, 25, 23);//Base of the whip
				...
				{
					frame.Y = 59;//where the third segment begins
					frame.Height = 16;
				}
				else if (i > 20)
				{
					frame.Y = 42;//Where the second segment begins
					frame.Height = 16;
				}
				else if (i > 10)
				{
					frame.Y = 22;//Where the first segment begins
					frame.Height = 16;
				}
				Vector2 element = list[i];
				Vector2 diff = list[i + 1] - element;
