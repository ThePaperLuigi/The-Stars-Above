    ...
    public class Prismic : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.myPlayer == player.whoAmI)
            {
                ...
                {//Circle
                    ...
                    Dust d2 = Dust.NewDustPerfect(Projectile.Center + offset, DustID.FireworkFountain_Pink, Vector2.Zero, 200, default, 0.5f);
                    d2.fadeIn = 0.1f;
                    d2.noGravity = true;
                }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int d = 0; d < 18; d++)
            {
                ...
                Dust.NewDust(Projectile.Center, 0, 0, DustID.GemAmethyst, Main.rand.NextFloat(-15, 15), Main.rand.NextFloat(-15, 15), 150, default, 0.7f);
                Dust.NewDust(Projectile.Center, 0, 0, DustID.PurpleCrystalShard, Main.rand.NextFloat(-8, 8), Main.rand.NextFloat(-8, 8), 150, default, 1f);
            }
