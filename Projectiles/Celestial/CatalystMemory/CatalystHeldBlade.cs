...
{
    public class CatalystHeldBlade : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Projectile.frameCounter >= frameSpeed && Projectile.frame > 0)
                {
                    Projectile.frameCounter = 0;
                    Projectile.frame--;
                ...
                {
                    //play withdraw sound.
                    SoundEngine.PlaySound(StarsAboveAudio.SFX_CatalystExtinguish, projOwner.Center);
                    startSound = true;
                    endSound = false;
                }
            }
