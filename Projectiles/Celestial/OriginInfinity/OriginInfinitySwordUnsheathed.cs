...
namespace StarsAbove.Projectiles.Celestial.OriginInfinity
{
    public class OriginInfinitySwordUnsheathed : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Celestial/OriginInfinity/OriginInfinitySwordUnsheathed";
