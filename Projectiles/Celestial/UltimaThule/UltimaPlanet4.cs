...
{
    public class UltimaPlanet4 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            double dist = 300 + initialDistance; //Distance away from the player
            ...
            Projectile.ai[1] += 1.4f + initialSpeed;
            Projectile.alpha -= 5;
            if (initialSpeed > 0f)
            {
                initialSpeed -= 0.2f;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int d = 0; d < 26; d++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 219, 0f + Main.rand.Next(-16, 16), 0f + Main.rand.Next(-16, 16), 150, default, 1.5f);
            }
            for (int d = 0; d < 30; d++)
            {
        ...
        {
            //default(Effects.UltimaRedTrail).Draw(Projectile);
