...
{
    //
    public class BuryTheLightSwing2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            projOwner.SetCompositeArmFront(true, Player.CompositeArmStretchAmount.Full, (projOwner.Center -
                                ...
                                ).ToRotation() + MathHelper.PiOver2); Vector2 ownerMountedCenter = projOwner.RotatedRelativePoint(projOwner.MountedCenter, true);
