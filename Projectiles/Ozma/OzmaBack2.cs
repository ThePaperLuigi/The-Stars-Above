...
{
	public class OzmaBack2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Projectile.position.X = ownerMountedCenter.X - (float)(Projectile.width / 2) - 15;
			Projectile.position.Y = ownerMountedCenter.Y - (float)(Projectile.height / 2) - 4;
