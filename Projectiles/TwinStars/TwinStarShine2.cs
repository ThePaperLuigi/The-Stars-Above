...
namespace StarsAbove.Projectiles.TwinStars
{
	public class TwinStarShine2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Projectile.position.X = player.GetModPlayer<StarsAbovePlayer>().starPosition2.X - (int)(Math.Cos(rad) * dist) - Projectile.width / 2;
			Projectile.position.Y = player.GetModPlayer<StarsAbovePlayer>().starPosition2.Y - (int)(Math.Sin(rad) * dist) - Projectile.height / 2;
