...
{
    public class AuthorityLantern2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (projOwner.dead && !projOwner.active || projOwner.GetModPlayer<WeaponPlayer>().SupremeAuthorityEncroachingStacks < 2)
			{
				Projectile.Kill();
			}
			if (firstSpawn)
