...
namespace StarsAbove.Projectiles.Takodachi
{
    ...
    public class TakodachiMinion : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.ai[0] > 60)
			{
				...
				{
					Projectile.ai[0] = 0;
					int type = ProjectileType<TakodachiRound>();
        ...
        private bool CheckActive(Player owner)
		{
			...
			{
				owner.ClearBuff(ModContent.BuffType<TakodachiBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<TakodachiBuff>()))
			{
