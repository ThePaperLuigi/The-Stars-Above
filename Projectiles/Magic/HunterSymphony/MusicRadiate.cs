...
namespace StarsAbove.Projectiles.Magic.HunterSymphony
{
                ...
                if (Projectile.ai[1] == 0)//Down
                {
                    ...
                    for (int i = 0; i < Main.maxPlayers; i++)
                    {
                        ...
                        if (other.active && !other.dead && other.team == player.team)
                        {
                            ...
                            for (int d = 0; d < 15; d++)
                            {
                                Dust.NewDust(other.Center, 0, 0, DustID.FireworkFountain_Red, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 0.8f);
                            }
                        }
                ...
                if (Projectile.ai[1] == 1)//Up
                {
                    ...
                    for (int i = 0; i < Main.maxPlayers; i++)
                    {
                        ...
                        if (other.active && !other.dead && other.team == player.team)
                        {
                            ...
                            for (int d = 0; d < 15; d++)
                            {
                                Dust.NewDust(other.Center, 0, 0, DustID.FireworkFountain_Blue, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 0.8f);
                            }
                        }
                ...
                if (Projectile.ai[1] == 2)//Left
                {
                    ...
                    for (int i = 0; i < Main.maxPlayers; i++)
                    {
                        ...
                        if (other.active && !other.dead && other.team == player.team)
                        {
                            ...
                            for (int d = 0; d < 15; d++)
                            {
                                Dust.NewDust(other.Center, 0, 0, DustID.FireworkFountain_Green, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 0.8f);
                            }
                        }
                ...
                if (Projectile.ai[1] == 3)//Right
                {
                    ...
                    for (int i = 0; i < Main.maxPlayers; i++)
                    {
                        ...
                        if (other.active && !other.dead && other.team == player.team)
                        {
                            ...
                            for (int d = 0; d < 15; d++)
                            {
                                Dust.NewDust(other.Center, 0, 0, DustID.FireworkFountain_Pink, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 0.8f);
                            }
                        }
