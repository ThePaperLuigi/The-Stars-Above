...
namespace StarsAbove.Projectiles.Magic.IrminsulDream
{
    public class VerdantSnapshot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int d = 0; d < 10; d++)
            {
                Dust.NewDust(Projectile.Center, 0, 0, DustID.GreenMoss, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 0.7f);
            }
            for (int d = 0; d < 24; d++)
            {
                Dust.NewDust(Projectile.Center, 0, 0, DustID.Firework_Green, 0f + Main.rand.Next(-7, 7), 0f + Main.rand.Next(-7, 7), 150, default, 0.5f);
            }

            for (int d = 0; d < 10; d++)
            {
                Dust.NewDust(Projectile.Center, 0, 0, DustID.FireworkFountain_Green, 0f + Main.rand.Next(-7, 7), 0f + Main.rand.Next(-7, 7), 150, default, 1.0f);
            }
            for (int d = 0; d < 10; d++)
            {
                Dust.NewDust(Projectile.Center, 0, 0, DustID.Firework_Green, 0f + Main.rand.Next(-7, 7), 0f + Main.rand.Next(-7, 7), 150, default, 0.6f);
            }
