    ...
    public class WarpStrike : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                Dust d = Dust.NewDustPerfect(position, 223, null, 240, default, 0.9f);
                d.fadeIn = 0.3f;
                d.noLight = true;
                d.noGravity = true;
            ...
            NetMessage.SendData(MessageID.TeleportEntity, -1, -1, null, 0, player.whoAmI, Projectile.Center.X, Projectile.Center.Y - 10, 1, 0, 0);
            Projectile.Kill();
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 22; i++)
            {
                int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 223, 0f + Main.rand.Next(-6, 6), 0f + Main.rand.Next(-6, 6), 100, default, 1.1f);
