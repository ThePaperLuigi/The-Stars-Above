    ...
    public class GundbitGunCharged : StarsAboveGun
    {
        ...
        public override void PostAI()
        {
            ...
            if (TransformationProgress >= 1f && projOwner.whoAmI == Main.myPlayer && projOwner.ownedProjectileCounts[ProjectileType<GundbitLaser>()] < 1)
            {
                ...
                int index = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0, 0, ProjectileType<GundbitLaser>(), Projectile.damage, 0f, projOwner.whoAmI);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D textureGundbit1 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit4");
            Texture2D textureGundbit2 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit5");
            Texture2D textureGundbit3 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit6");
            Texture2D textureGundbit4 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit1");
            Texture2D textureGundbit5 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit2");
            Texture2D textureGundbit6 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit3");
            Texture2D textureGundbit7 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit7");
            Texture2D textureGundbit8 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit8");
            Texture2D textureGundbit9 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit9");
            Texture2D textureGundbit10 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit10");
            Texture2D textureGundbit11 = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Magic/Gundbit/Gundbit11");
