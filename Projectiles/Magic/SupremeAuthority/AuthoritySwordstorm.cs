...
namespace StarsAbove.Projectiles.Magic.SupremeAuthority
{
    public class AuthoritySwordstorm : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.frame < 3)
            {
                ...
                for (int i = 0; i < dustAmount; i++)
                {
                    ...
                    spinningpoint5 += -Vector2.UnitY.RotatedBy(i * ((float)Math.PI * 2f / dustAmount)) * new Vector2(1f + Projectile.scale * 195, 6f + Projectile.scale * 8);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(Projectile.Center, 0, 0, DustID.GemAmethyst, 0f + Main.rand.Next(-13, 13), 0f + Main.rand.Next(-13, 13), 150, default, 1f);
