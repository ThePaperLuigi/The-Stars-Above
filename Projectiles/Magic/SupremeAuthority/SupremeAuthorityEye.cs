                ...
                for (int i = 0; i < Main.maxNPCs; i++)
                {
                    ...
                    if (npc.active && npc.friendly && npc.HasBuff(BuffType<AuthoritySacrificeMark>()))
                    {
                        ...
                        for (int ir = 0; ir < 30; ir++)
                        {
                            ...
                            Dust da = Dust.NewDustPerfect(position, DustID.GemTopaz, null, 0, default, 0.4f);
                            da.noLight = false;
                            da.noGravity = true;
                    ...
                    for (int i = 0; i < Main.maxNPCs; i++)
                    {
                        ...
                        if (npc.active && npc.friendly && npc.Distance(Projectile.Center) < 660)
                        {
                            ...
                            for (int ir = 0; ir < 50; ir++)
                            {
                                ...
                                Dust da = Dust.NewDustPerfect(position, DustID.GemTopaz, null, 240, default, 2.7f);
                                da.fadeIn = 0.5f;
                                da.noLight = false;
                                da.noGravity = true;
                            ...
                            {
                                Dust.NewDust(npc.Center, 0, 0, DustID.GemTopaz, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 1.5f);
                            }
                            ...
                            {
                                int dustIndex = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y), 0, 0, DustID.GemTopaz, 0f + Main.rand.Next(-26, 26), 0f + Main.rand.Next(-6, 6), 100, default, 2f);
                            ...
                            for (int d1 = 0; d1 < 15; d1++)
                            {
                                Dust.NewDust(player.Center, 0, 0, DustID.GemAmethyst, 0f + Main.rand.Next(-7, 7), 0f + Main.rand.Next(-3, 3), 150, default, 1f);
                                Dust.NewDust(player.Center, 0, 0, DustID.GemTopaz, 0f + Main.rand.Next(-3, 3), 0f + Main.rand.Next(-3, 3), 150, default, 1f);
