...
namespace StarsAbove.Projectiles.Magic.EternalStar
{
    public class EmblazonedVermillion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 219, Main.rand.NextFloat(-1, 1), Main.rand.NextFloat(-1, 1), 100, default, 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 70; i++)
            {
                int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 219, Main.rand.NextFloat(-25, 25), Main.rand.NextFloat(-25, 25), 100, default, 1f);
                Main.dust[dustIndex].noGravity = true;

                dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 219, Main.rand.NextFloat(-20, 20), Main.rand.NextFloat(-20, 20), 100, default, 2f);
