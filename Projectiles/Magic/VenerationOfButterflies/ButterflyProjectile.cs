...
namespace StarsAbove.Projectiles.Magic.VenerationOfButterflies
{
    public class ButterflyProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust2 = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, 204,
                    0, 0, 254, Scale: 0.3f);
                dust2.shader = GameShaders.Armor.GetSecondaryShader(44, Main.LocalPlayer);
