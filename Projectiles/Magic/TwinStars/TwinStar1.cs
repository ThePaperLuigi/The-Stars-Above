...
namespace StarsAbove.Projectiles.Magic.TwinStars
{
    public class TwinStar1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.position.Y = ownerMountedCenter.Y - Projectile.height / 2 - 200;
            ...
            {//Circle
                ...
                Dust d = Dust.NewDustPerfect(Projectile.Center + offset, 219, Vector2.Zero, 200, default, 0.2f);
                d.fadeIn = 0.1f;
                d.noGravity = true;
            }
            ...
            {//Circle
                ...
                Dust d = Dust.NewDustPerfect(Projectile.Center + offset, 226, Vector2.Zero, 200, default, 0.2f);
                d.fadeIn = 0.1f;
                d.noGravity = true;
            }
            for (int i = 0; i < 5; i++)
