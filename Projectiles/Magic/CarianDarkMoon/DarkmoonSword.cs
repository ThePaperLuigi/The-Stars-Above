...
{
    public class DarkmoonSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Magic/CarianDarkMoon/DarkmoonSword";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 60;
        public override Color BackDarkColor => new Color(61, 111, 116);
        public override Color MiddleMediumColor => new Color(111, 166, 172);
        public override Color FrontLightColor => new Color(154, 199, 203);
