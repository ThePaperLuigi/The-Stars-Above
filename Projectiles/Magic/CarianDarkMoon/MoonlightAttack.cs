    ...
    internal class MoonlightAttack : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= 60f)
            {
                ...
                for (int d = 0; d < 16; d++)
                {
                    Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y), 0, 0, 20, 0f + Main.rand.Next(-6, 6), 0f + Main.rand.Next(-6, 6), 150, default, 1f);
                }
                for (int d = 0; d < 12; d++)
                {
                    Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y), 0, 0, 221, 0f + Main.rand.Next(-6, 6), 0f + Main.rand.Next(-6, 6), 150, default, 1f);
                }
                Projectile.Kill();
            }
