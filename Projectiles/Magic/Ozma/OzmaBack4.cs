...
namespace StarsAbove.Projectiles.Magic.Ozma
{
    public class OzmaBack4 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.position.X = ownerMountedCenter.X - Projectile.width / 2 - 6;
            Projectile.position.Y = ownerMountedCenter.Y - Projectile.height / 2 - 5;
            ...
            UpdateMovement();
            DrawOriginOffsetY += -projOwner.GetModPlayer<WeaponPlayer>().OzmaSpikeVFXProgression * 3;
