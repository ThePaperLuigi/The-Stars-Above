...
namespace StarsAbove.Projectiles.Magic.LightUnrelenting
{
    public class LightUnrelentingSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Magic/LightUnrelenting/LightUnrelentingSword";
        ...
        public override float EffectScaleAdder => 0.8f;
