...
namespace StarsAbove.Projectiles.Magic.DraggedBelow
{
    ...
    public class DraggedBelowLaserCorrupt : ModProjectile
    {
        ...
        private void SpawnDusts(Player player)
        {
            ...
            for (int d = 0; d < 2; d++)
            {
                ...
                int dustIndex = Dust.NewDust(Projectile.Center - Vector2.One * 4f, 0, 0, DustID.LifeDrain, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 1f);
        ...
        private void ChargeLaser(Player player)
        {
            ...
            if (!player.channel || !player.HasBuff(BuffType<DraggedBelowCorruption>()))
            {
                Projectile.Kill();
            }
            else
        ...
        private void UpdatePlayer(Player player)
        {
            ...
            {
                Vector2 diff = player.GetModPlayer<WeaponPlayer>().DraggedBelowTarget2 - player.MountedCenter;
                diff.Normalize();
                Projectile.velocity = diff;
                Projectile.direction = player.GetModPlayer<WeaponPlayer>().DraggedBelowTarget2.X > player.MountedCenter.X ? 1 : -1;
