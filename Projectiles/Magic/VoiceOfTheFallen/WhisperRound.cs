...
namespace StarsAbove.Projectiles.Magic.VoiceOfTheFallen
{
    public class WhisperRound : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("WhisperRound");     //The English name of the projectile
