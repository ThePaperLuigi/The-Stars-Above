...
{
    //
    public class MookSlashes : ModProjectile
	{
			...
			if (++Projectile.frameCounter >= 3)
			{
				...
				if (Projectile.frame < 9)
				{
					for (int i = 0; i < 3; i++)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(),vel, Vector2.Zero, ProjectileType<BlackSilenceSlash>(), 0, Projectile.knockBack, Projectile.owner, 0, 1);
					}
