...
{
    public class DancingFoxfire1 : ModProjectile
	{
		public override void SetStaticDefaults() {
			// DisplayName.SetDefault("DancingFoxfire1");     //The English name of the projectile
		...
		public override void AI()
		{
			...
			if (player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse1>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse2>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse3>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse4>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse5>()] >= 1)
			{
			...
			if (Projectile.ai[0] > 80)
			{
				...
				{
					Projectile.ai[0] = 0;
					int type = ProjectileType<Projectiles.Icebolt>();
					...
					for (int d = 0; d < 6; d++)
					{
						Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 221, 0f + Main.rand.Next(-2, 2), 0f + Main.rand.Next(-2, 2), 150, default(Color), 1.5f);
					}
