...
{
    public class BlizzardFoxfire3 : ModProjectile
	{
		public override void SetStaticDefaults() {
			// DisplayName.SetDefault("BlizzardFoxfire2");     //The English name of the projectile
		...
		public override void AI()
		{
			...
			if (player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse6>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse7>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse8>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse9>()] >= 1)
			{
			...
			double dist = 188; //Distance away from the player
			...
			if (Projectile.ai[0] > 60)
			{
				...
				{
					Projectile.ai[0] = 0;
					int type = ProjectileType<Projectiles.Icebolt2>();
