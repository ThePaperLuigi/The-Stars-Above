...
namespace StarsAbove.Projectiles.Kifrosse
{
    public class DancingFoxfire2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse3>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse4>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Kifrosse.Kifrosse5>()] >= 1)
			{
