...
namespace StarsAbove.Projectiles
{
    public class NaganadelProjectile4 : ModProjectile
	{
		...
		public override void AI() {
			...
			if (projOwner.GetModPlayer<StarsAbovePlayer>().naganadelWeapon4Summoned == false) {
				if (Projectile.owner == Main.myPlayer)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.position.X + (Projectile.width / 2), Projectile.position.Y + (Projectile.height / 2), (Main.MouseWorld).ToRotation(), (Main.MouseWorld).ToRotation(), ProjectileType<NaganadelProjectileFinal4>(), (int)(Projectile.damage * 10), 0f, Projectile.owner, 0f, 0f);
