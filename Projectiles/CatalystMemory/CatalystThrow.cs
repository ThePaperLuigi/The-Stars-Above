		...
		public override void AI() {
			...
			if (distance < 30f)
			{
				...
				for (int d = 0; d < 27; d++)//Visual effects
				{
					...
					perturbedSpeed = -(perturbedSpeed * scale);
					int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, DustID.GemAmethyst, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 0.6f);
					Main.dust[dustIndex].noGravity = true;
				...
				for (int d = 0; d < 27; d++)//Visual effects
				{
					...
					perturbedSpeed = -(perturbedSpeed * scale);
					int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, DustID.PurpleCrystalShard, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 0.6f);
					Main.dust[dustIndex].noGravity = true;
				...
				for (int d = 0; d < 63; d++)//Visual effects
				{
					...
					perturbedSpeed = -perturbedSpeed * scale;
					int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, DustID.FireworkFountain_Pink, perturbedSpeed.X, perturbedSpeed.Y, 150, default(Color), 1.6f);
					Main.dust[dustIndex].noGravity = true;
