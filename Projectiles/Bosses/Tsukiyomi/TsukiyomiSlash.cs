        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1)
            {
                ...
                for (int d = 0; d < 2; d++)
                {
                    ...
                    int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 221, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 1f);
                ...
                for (int d = 0; d < 3; d++)
                {
                    ...
                    int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 20, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 2f);
                    Main.dust[dustIndex].noGravity = true;
                }
                /*for (int d = 0; d < 2; d++)
				{
