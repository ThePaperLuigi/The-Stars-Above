    ...
    public class TsukiTentacleCircle : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if(Projectile.timeLeft < 150 && !tentacleAttack)
			{
				...
				float Speed = 15f;
				int type = Main.rand.Next(new int[] { ProjectileType<TsukiTentacle1>(), ProjectileType<TsukiTentacle2>(), ProjectileType<TsukiTentacle3>() });
				tentacleAttack = true;
            ...
            {
				Projectile.rotation = MathHelper.ToRadians(Projectile.ai[0]);//+ MathHelper.ToRadians(-135f)
