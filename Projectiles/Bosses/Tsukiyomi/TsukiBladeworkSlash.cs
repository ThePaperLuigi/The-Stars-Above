		...
		public override void AI() {
			...
			if (Projectile.timeLeft <= 15)
            {
				...
				if (Projectile.localAI[0] >= 1)
				{
					if(Projectile.timeLeft == 15)
                    {
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * speed / 999)), (float)((Math.Sin(Projectile.rotation) * speed / 999)), ModContent.ProjectileType<TsukiBladeworkDamage>(), damage, 0f, 0);
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * speed / 999) * -1), (float)((Math.Sin(Projectile.rotation) * speed / 999) * -1), ModContent.ProjectileType<TsukiBladeworkDamage>(), damage, 0f, 0);

					}

					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * speed) * -1), (float)((Math.Sin(Projectile.rotation) * speed) * -1), ModContent.ProjectileType<TsukiBladeworkDamage>(), damage, 0f, 0);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(Projectile.rotation) * speed)), (float)((Math.Sin(Projectile.rotation) * speed)), ModContent.ProjectileType<TsukiBladeworkDamage>(), damage, 0f, 0);
