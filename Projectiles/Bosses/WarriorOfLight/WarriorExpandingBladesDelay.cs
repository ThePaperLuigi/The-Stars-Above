...
{
    public class WarriorExpandingBladesDelay : ModProjectile
	{
		...
		public override void AI()
		{
			...
			//Orbit ai[0] is the max orbit distance, ai[1] is the rotation starting position
			...
			for (int i = 0; i < Main.maxNPCs; i++)
			{
				...
				if (other.active && (other.type == ModContent.NPCType<WarriorOfLightBoss>()))

				{
					...
					Projectile.rotation = Vector2.Normalize(other.Center - Projectile.Center).ToRotation() + MathHelper.ToRadians(-135f);
					return;
				}
			}
		}
