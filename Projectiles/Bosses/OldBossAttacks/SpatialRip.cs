...
{
    public class SpatialRip : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Spatial Rip");     //The English name of the projectile
        ...
        {
            projectileTimer++;
            if (projectileTimer >= 50 && timesWillShoot > 0)
            {
                ...
                for (int i = 0; i < 7; i++)
                {
                    ...
                    Vector2 vel = new Vector2(Main.rand.NextFloat(-6, 6), 0);
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, vel, ProjectileID.DemonSickle, 30, Projectile.knockBack, Projectile.owner, 0, 1);
                }
