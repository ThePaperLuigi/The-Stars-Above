...
{
    public class ChaosBlaster : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)(Math.Cos(Projectile.rotation) * Speed * -1), (float)(Math.Sin(Projectile.rotation) * Speed * -1), 438, 30, 0f, 0);
                Projectile.ai[0] = 0;
            }
            // Fade in
