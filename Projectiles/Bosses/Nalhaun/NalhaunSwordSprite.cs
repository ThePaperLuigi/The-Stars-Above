...
namespace StarsAbove.Projectiles.Bosses.Nalhaun
{
    public class NalhaunSwordSprite : ModProjectile
	{
		...
		public override void AI() {
			...
			for (int d = 0; d < 2; d++)
			{
				Dust.NewDust(new Vector2(Projectile.Center.X,Projectile.Center.Y + 15), 0, 0, DustID.FireworkFountain_Red, 0f + Main.rand.Next(-20, 20), 0f + Main.rand.Next(-20, 20), 150, default(Color), 1.5f);
			}
