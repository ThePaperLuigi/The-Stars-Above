                ...
                if (++Projectile.frameCounter >= 3)
                {
                    ...
                    else
                    {
                        for (int d = 0; d < 8; d++)
                        {
                            ...
                            int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 82, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 1f);
                        ...
                        for (int d = 0; d < 5; d++)
                        {
                            ...
                            int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, 82, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 2f);
                            Main.dust[dustIndex].noGravity = true;
                        }
                        for (int d = 0; d < 8; d++)
                        {
