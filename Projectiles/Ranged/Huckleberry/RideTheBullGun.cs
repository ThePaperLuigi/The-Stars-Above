...
namespace StarsAbove.Projectiles.Ranged.Huckleberry
{
    public class RideTheBullGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/Huckleberry/RideTheBullGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/Huckleberry/RideTheBullFlash";
