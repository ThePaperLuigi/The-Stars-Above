...
{
    public class QuisUtDeusGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/QuisUtDeus/QuisUtDeusGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/QuisUtDeus/QuisUtDeusFlash";
        ...
        public override int FlashDustID => Terraria.ID.DustID.GemAmethyst;
