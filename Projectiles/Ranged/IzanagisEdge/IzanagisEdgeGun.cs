...
namespace StarsAbove.Projectiles.Ranged.IzanagisEdge
{
    public class IzanagisEdgeGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/IzanagisEdge/IzanagisEdgeGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/IzanagisEdge/IzanagisEdgeFlash";
        ...
        public override int MuzzleDistance => 82;
        ...
        public override int ScreenShakeTime => 90; //100 is disabled
