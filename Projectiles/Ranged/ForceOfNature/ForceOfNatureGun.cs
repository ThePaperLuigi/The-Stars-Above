...
namespace StarsAbove.Projectiles.Ranged.ForceOfNature
{
    public class ForceOfNatureGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/ForceOfNature/ForceOfNatureGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/ForceOfNature/ForceOfNatureFlash";
