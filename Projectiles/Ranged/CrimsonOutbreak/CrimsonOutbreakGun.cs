...
namespace StarsAbove.Projectiles.Ranged.CrimsonOutbreak
{
    public class CrimsonOutbreakGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/CrimsonOutbreak/CrimsonOutbreakGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/CrimsonOutbreak/CrimsonOutbreakFlash";
