...
{
    public class DroneGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/ElCapitansHardware/DroneGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/ElCapitansHardware/DroneGunFlash";
