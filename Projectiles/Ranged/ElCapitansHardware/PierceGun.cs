...
namespace StarsAbove.Projectiles.Ranged.ElCapitansHardware
{
    public class PierceGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/ElCapitansHardware/PierceGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/ElCapitansHardware/PierceGunFlash";
