...
namespace StarsAbove.Projectiles.Ranged.Tartaglia
{
    public class RiptideBolt : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Riptide Bolt");     //The English name of the projectile
