...
{
    public class TwoCrownBowSkyAttack : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            double dist = 530; //Distance away from the player
            ...
            {
                Projectile.ai[0] = 0;
                int type = ProjectileType<TwoCrownBowArrowDebuff>();
                ...
                Vector2 velocity = new Vector2(direction.X, direction.Y).RotatedByRandom(MathHelper.ToRadians(20)) * launchSpeed;
