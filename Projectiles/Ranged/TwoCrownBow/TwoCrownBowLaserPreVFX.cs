...
{
    public class TwoCrownBowLaserPreVFX : ModProjectile
    {
        ...
        {                      
            ...
            Texture2D texture = (Texture2D)Request<Texture2D>("StarsAbove/Effects/WarriorVFX");
            ...
            Vector2 drawPos = Main.player[Projectile.owner].Center - Main.screenPosition;

            float rotation = MathHelper.ToRadians(Projectile.ai[2]);
