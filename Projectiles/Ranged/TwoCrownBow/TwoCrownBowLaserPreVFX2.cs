...
{
    public class TwoCrownBowLaserPreVFX2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projOwner.dead && !projOwner.active || (!projOwner.HasBuff(BuffType<Buffs.TwoCrownBow.StellarTerminationPreBuff>()) && !projOwner.HasBuff(BuffType<Buffs.TwoCrownBow.StellarTerminationBuff>())))
            {
                Projectile.alpha += 50;
            }
            else
        ...
        {                      
            ...
            Texture2D texture = (Texture2D)Request<Texture2D>("StarsAbove/Projectiles/Ranged/TwoCrownBow/TwoCrownSigilSquish");
