...
{
    public class DevotedHavocGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/DevotedHavoc/DevotedHavocGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/DevotedHavoc/DevotedHavocFlash";
