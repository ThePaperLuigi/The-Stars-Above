...
{
    public class InheritedCaseGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Ranged/InheritedCaseM4A1/InheritedCaseGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Ranged/InheritedCaseM4A1/InheritedCaseGunFlash";
