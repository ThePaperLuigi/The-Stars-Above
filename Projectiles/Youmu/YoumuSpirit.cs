	...
	public class YoumuSpirit : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.ai[0] > 40)
			{
				...
				{
					Projectile.ai[0] = 0;
					int type = ProjectileType<YoumuRound>();
		...
		private bool CheckActive(Player owner)
		{
			...
			{
				owner.ClearBuff(ModContent.BuffType<PhantomMinion>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<PhantomMinion>()) && owner.HeldItem.ModItem is KonpakuKatana)
			{
