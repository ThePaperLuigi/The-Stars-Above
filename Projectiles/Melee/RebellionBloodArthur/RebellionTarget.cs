...
{
    public class RebellionTarget : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Levinstorm Axe VFX");     //The English name of the projectile
            ProjectileID.Sets.TrailCacheLength[Projectile.type] = 0;    //The length of old position to be recorded
        ...
        public override void AI()
        {
            ...
            player.GetModPlayer<WeaponPlayer>().rebellionTarget = Projectile.Center;
            if (Projectile.ai[0] < 0)
            {
