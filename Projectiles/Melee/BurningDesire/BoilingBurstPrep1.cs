...
namespace StarsAbove.Projectiles.Melee.BurningDesire
{
    public class BoilingBurstPrep1 : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Main.player[Projectile.owner].Center, Vector2.Zero, ProjectileType<BoilingBurstExplosion>(), Projectile.damage, 0f, Projectile.owner, 0f, 0f);
