...
namespace StarsAbove.Projectiles.Melee.CrimsonSakuraAlpha
{
    public class CrimsonSakuraAlphaSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Melee/CrimsonSakuraAlpha/CrimsonSakuraAlphaSword";
