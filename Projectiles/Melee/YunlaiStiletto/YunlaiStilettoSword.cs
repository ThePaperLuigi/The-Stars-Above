...
{
    public class YunlaiStilettoSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Melee/YunlaiStiletto/YunlaiStilettoSword";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 60;
        public override Color BackDarkColor => new Color(134, 57, 207);
        public override Color MiddleMediumColor => new Color(191, 118, 222);
        public override Color FrontLightColor => new Color(228, 184, 247);
        public override bool CenterOnPlayer => true;
        public override bool Rotate45Degrees => true;
        public override float EffectScaleAdder => 1f;
