...
namespace StarsAbove.Projectiles.Melee.Xenoblade
{
    public class MonadoShield : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.position.Y = ownerMountedCenter.Y - Projectile.height / 2 - 110;
