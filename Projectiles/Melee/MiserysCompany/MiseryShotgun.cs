...
{
    public class MiseryShotgun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Melee/MiserysCompany/MiseryShotgun";
        public override string TextureFlash => "StarsAbove/Projectiles/Melee/MiserysCompany/MiseryShotgunFlash";
