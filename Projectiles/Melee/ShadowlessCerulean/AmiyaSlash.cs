...
namespace StarsAbove.Projectiles.Melee.ShadowlessCerulean
{
    //
    public class AmiyaSlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (++Projectile.frameCounter >= 5)
            {
                ...
                else
                {
                    ...
                    for (int d = 0; d < 24; d++)
                    {
                        Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 20, 0f + Main.rand.Next(-25, 25), 0f + Main.rand.Next(-25, 25), 150, default, 1.5f);
                    }
                    for (int d = 0; d < 46; d++)
                    {
                        Dust.NewDust(new Vector2(Projectile.position.X + 150, Projectile.position.Y + 150), 0, 0, 221, 0f + Main.rand.Next(-36, 36), 0f, 150, default, 1.5f);
                    }
                    for (int d = 0; d < 46; d++)
                    {
                        Dust.NewDust(new Vector2(Projectile.position.X + 150, Projectile.position.Y + 150), 0, 0, 20, 0f + Main.rand.Next(-36, 36), 0f, 150, default, 1.5f);
                    }
                    for (int d = 0; d < 20; d++)
                    {
                        Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 221, 0f + Main.rand.Next(-33, 33), 0f + Main.rand.Next(-33, 33), 150, default, 1.5f);
                    }
