...
namespace StarsAbove.Projectiles.Melee.Hullwrought
{
    public class HullwroughtRound : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDust(Projectile.Center, 0, 0, 20, 0f + Main.rand.Next(-5, 5), 0f + Main.rand.Next(-5, 5), 150, default, 1.5f);
            ...
            for (int d = 0; d < 20; d++)
            {
                ...
                Dust.NewDustPerfect(position, 43, new Vector2(0f, 0f), 0, new Color(255, 255, 255), 1f);
            }
