...
{
    public class KarnaChargedMelee : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int d = 0; d < 8; d++)
            {
                ...
                Dust.NewDust(target.Center, 0, 0, DustID.Flare, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-15, 15), 150, default, 0.6f);
