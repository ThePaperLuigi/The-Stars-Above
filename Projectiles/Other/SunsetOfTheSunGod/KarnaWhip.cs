...
{
    public class KarnaWhip : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.WhipSettings.Segments = 1;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Rectangle frame = new Rectangle(0, 0, 46, 216);//Base of the whip
                Vector2 origin = new Vector2(23, 30);
                float scale = 1;
