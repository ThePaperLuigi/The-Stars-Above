...
{
    //
    public class GoldenKatanaChargeAttack1 : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            for (int d = 0; d < 32; d++)
            {
                Dust.NewDust(target.Center, 0, 0, DustID.Clentaminator_Blue, 0f + Main.rand.Next(-6, 6), 0f + Main.rand.Next(-6, 6), 150, default, 1.2f);
            }
