...
{
    public class GoldenKatanaSheath : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projOwner.ownedProjectileCounts[ProjectileType<GoldenKatanaHeld>()] >= 1 || projOwner.ownedProjectileCounts[ProjectileType<GoldenKatanaChargeAttack1>()] >= 1 || projOwner.ownedProjectileCounts[ProjectileType<GoldenKatanaChargeAttack2>()] >= 1 || projOwner.ownedProjectileCounts[ProjectileType<GoldenKatanaChargeAttack3>()] >= 1)
            {
