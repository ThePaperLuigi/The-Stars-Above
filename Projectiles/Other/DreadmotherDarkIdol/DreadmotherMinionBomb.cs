...
{
    public class DreadmotherMinionBomb : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<DreadmotherMinionBombExplosion>(), Projectile.damage, 0, Main.player[Projectile.owner].whoAmI);
			}
		}
	}
}
