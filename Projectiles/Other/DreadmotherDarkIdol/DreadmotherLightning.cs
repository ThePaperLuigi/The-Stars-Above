...
{
    public class DreadmotherLightning : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int num360 = 0; num360 < 2; num360++)
            {
                ...
                if (num360 == 0)
                {
                    ...
                    DelegateMethods.c_1 = new Color(39, 64, 250, 0) * 0.5f; //This is the color of the lightning!
                }
                else
                {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            for (int d = 0; d < 8; d++)
            {
                Dust.NewDust(target.Center, 0, 0, DustID.Electric, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5), 150, default, 0.7f);
