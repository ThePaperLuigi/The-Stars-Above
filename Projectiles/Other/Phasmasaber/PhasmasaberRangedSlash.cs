...
{
    public class PhasmasaberRangedSlash : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Other/Phasmasaber/PhasmasaberRangedSlash";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 20;
        public override Color BackDarkColor => new Color(65, 29, 112);
        public override Color MiddleMediumColor => new Color(96, 118, 196);
        public override Color FrontLightColor => new Color(100, 189, 238);
        public override bool CenterOnPlayer => true;
        public override bool Rotate45Degrees => true;
        public override float EffectScaleAdder => 0.4f;
