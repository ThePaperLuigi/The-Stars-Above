...
{
    public class WolvesbaneBlastExplosion : ModProjectile
	{
        ...
        public override void OnKill(int timeLeft)
		{
			...
			for (int d = 0; d < 24; d++)
			{
				Dust.NewDust(Projectile.Center, 0, 0, DustID.Torch, 0f + Main.rand.Next(-15, 15), 0f + Main.rand.Next(-15, 15), 150, default(Color), 2.5f);
			}
