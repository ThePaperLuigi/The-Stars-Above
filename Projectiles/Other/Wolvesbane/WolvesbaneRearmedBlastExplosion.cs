...
{
    public class WolvesbaneRearmedBlastExplosion : ModProjectile
	{
        ...
        public override void OnKill(int timeLeft)
		{
			...
			for (int d = 0; d < 55; d++)
			{
				Dust.NewDust(Projectile.Center, 0, 0, DustID.FireworkFountain_Red, 0f + Main.rand.Next(-15, 15), 0f + Main.rand.Next(-15, 15), 150, default(Color), 1.5f);
			}
			for (int d = 0; d < 55; d++)
			{
				Dust.NewDust(Projectile.Center, 0, 0, DustID.LifeDrain, 0f + Main.rand.Next(-15, 15), 0f + Main.rand.Next(-15, 15), 150, default(Color), 2.5f);
			}
