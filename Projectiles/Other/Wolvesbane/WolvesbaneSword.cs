...
{
    public class WolvesbaneSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Other/Wolvesbane/WolvesbaneSword";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 60;
        public override Color BackDarkColor => new Color(83, 83, 207);
        public override Color MiddleMediumColor => new Color(91, 126, 217);
        public override Color FrontLightColor => new Color(105, 210, 199);
