...
{
    public class WolvesbaneRearmedGun : StarsAboveGun
    {
        public override string Texture => "StarsAbove/Projectiles/Other/Wolvesbane/WolvesbaneRearmedGun";
        public override string TextureFlash => "StarsAbove/Projectiles/Other/Wolvesbane/WolvesbaneGunFlash";
        ...
        public override float RecoilStrength => 10f;
