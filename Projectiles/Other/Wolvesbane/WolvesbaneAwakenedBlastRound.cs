...
{
    public class WolvesbaneAwakenedBlastRound : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<WolvesbaneAwakenedFinisher>(), Projectile.damage * 4, 0, Main.player[Projectile.owner].whoAmI);
            }
        }
    }
}
