...
{
    public class ArchitectSword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Other/ArchitectLuminance/ArchitectSword";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 60;
        public override Color BackDarkColor => new Color(41, 188, 114);
        public override Color MiddleMediumColor => new Color(118, 231, 175);
        public override Color FrontLightColor => new Color(216, 255, 201);
        public override bool CenterOnPlayer => true;
        public override bool Rotate45Degrees => true;
        public override float EffectScaleAdder => 1.4f;
