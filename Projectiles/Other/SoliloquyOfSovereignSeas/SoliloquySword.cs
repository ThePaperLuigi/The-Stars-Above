...
{
    public class SoliloquySword : StarsAboveSword
    {
        public override string Texture => "StarsAbove/Projectiles/Other/SoliloquyOfSovereignSeas/SoliloquySword";
        public override bool UseRecoil => false;
        public override bool DoSpin => false;
        public override float BaseDistance => 60;
        public override Color BackDarkColor => new Color(90, 194, 204);
        public override Color MiddleMediumColor => new Color(137, 214, 222);
        public override Color FrontLightColor => new Color(196, 244, 249);
