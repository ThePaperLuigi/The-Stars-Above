...
{
    public class SirenTurret2 : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("SirenTurret2");     //The English name of the projectile
		...
		public override void AI()
		{
			...
			player.GetModPlayer<StarsAbovePlayer>().sirenTurretCenter2 = Projectile.Center;
