...
namespace StarsAbove.Projectiles.SanguineDespair
{
    public class SanguineDespairBolt : ModProjectile
	{
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
			...
			for (int d = 0; d < 18; d++)
			{
				Dust.NewDust(target.Center, 0, 0, DustID.LifeDrain, Main.rand.NextFloat(-4, 4), Main.rand.NextFloat(-2, 2), 150, default(Color), 1f);
        ...
        public override void Kill(int timeLeft)
		{
			for (int d = 0; d < 18; d++)
			{
				Dust.NewDust(Projectile.Center, 0, 0, DustID.LifeDrain, Main.rand.NextFloat(-4, 4), Main.rand.NextFloat(-2, 2), 150, default(Color), 1f);
				Dust.NewDust(Projectile.Center, 0, 0, DustID.FireworkFountain_Red, Main.rand.NextFloat(-2, 2), Main.rand.NextFloat(-2, 2), 150, default(Color), 0.4f);
