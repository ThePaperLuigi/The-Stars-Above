...
namespace StarsAbove.Projectiles.Summon.Kifrosse
{
    public class BlizzardFoxfire2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.Kifrosse6>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse7>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.Kifrosse8>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.Kifrosse9>()] >= 1)
            {
            ...
            if (Projectile.ai[0] > 60 && foundTarget)
            {
                ...
                {
                    Projectile.ai[0] = 0;
                    int type = ProjectileType<Icebolt2>();
