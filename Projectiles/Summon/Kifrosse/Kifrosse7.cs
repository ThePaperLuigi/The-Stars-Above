...
{
    public class Kifrosse7 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.BlizzardFoxfire1>()] < 1)
            {
                int index = Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.position.X, player.position.Y, 0, 0, ProjectileType<Projectiles.Summon.Kifrosse.BlizzardFoxfire1>(), Projectile.damage, 4, player.whoAmI, 0f);

                Main.projectile[index].originalDamage = Projectile.damage;

            }
            if (player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.BlizzardFoxfire2>()] < 1)
            {
                int index = Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.position.X, player.position.Y, 0, 0, ProjectileType<Projectiles.Summon.Kifrosse.BlizzardFoxfire2>(), Projectile.damage, 4, player.whoAmI, 0f);
