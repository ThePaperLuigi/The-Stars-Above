...
{
    public class Kifrosse1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<DancingFoxfire1>()] < 1)
            {
                int index = Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.position.X, player.position.Y, 0, 0, ProjectileType<DancingFoxfire1>(), Projectile.damage, 4, player.whoAmI, 0f);
