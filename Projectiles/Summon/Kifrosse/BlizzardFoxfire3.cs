...
namespace StarsAbove.Projectiles.Summon.Kifrosse
{
    public class BlizzardFoxfire3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<Kifrosse6>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse7>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse8>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse9>()] >= 1)
            {
