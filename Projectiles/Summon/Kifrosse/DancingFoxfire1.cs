...
namespace StarsAbove.Projectiles.Summon.Kifrosse
{
    public class DancingFoxfire1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<Projectiles.Summon.Kifrosse.Kifrosse1>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse2>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse3>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse4>()] >= 1 || player.ownedProjectileCounts[ProjectileType<Kifrosse5>()] >= 1)
            {
            ...
            if (Projectile.ai[0] > 80 && foundTarget)
            {
                ...
                {
                    Projectile.ai[0] = 0;
                    int type = ProjectileType<Icebolt>();
