...
{
    public class Kifrosse3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ProjectileType<DancingFoxfire2>()] < 1)
            {
                int index = Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.position.X, player.position.Y, 0, 0, ProjectileType<DancingFoxfire2>(), Projectile.damage, 4, player.whoAmI, 0f);
                Main.projectile[index].originalDamage = Projectile.damage;
