...
namespace StarsAbove.Projectiles.Summon.KeyOfTheSinner
{
    public class SatanaelRound : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Satanael");     //The English name of the projectile
