...
{
    public class RedStarBit : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int d = 0; d < 2; d++)
            {
                ...
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, 115,
                    Projectile.velocity.X * .2f, Projectile.velocity.Y * .2f, 200, new Color(0, 42, 255), Scale: 1.2f);
                dust.noGravity = true;
                dust.velocity += Projectile.velocity * 0.3f;
                dust.velocity *= 0.2f;

                Dust dust2 = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, 115,
