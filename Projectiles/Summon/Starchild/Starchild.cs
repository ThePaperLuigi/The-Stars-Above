...
namespace StarsAbove.Projectiles.Summon.Starchild
{
    ...
    public class StarchildBuff : ModBuff
    {
        ...
        {
            if (player.ownedProjectileCounts[ProjectileType<Starchild>()] > 0)
            {
	 ...
	 */
    public class Starchild : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Starchild");
        ...
        public override void AI()
        {
            ...
            if (player.dead || !player.active)
            {
                ...
                player.ClearBuff(BuffType<StarchildBuff>());


            }
            if (player.HasBuff(BuffType<StarchildBuff>()) && player.HeldItem.ModItem is LuminaryWand)
            {
