...
{
    public class SugartleBubble : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Dust.NewDust(target.Center, 0, 0, DustID.Water, 0f + Main.rand.Next(-7, 7), 0f + Main.rand.Next(-7, 7), 150, default, 0.9f);
            ...
            {
                target.AddBuff(ModContent.BuffType<Riptide>(), 240);
