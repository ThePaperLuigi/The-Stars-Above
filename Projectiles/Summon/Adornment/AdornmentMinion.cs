...
namespace StarsAbove.Projectiles.Summon.Adornment
{
    public class AdornmentMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!player.HasBuff(BuffType<AdornmentMinionBuff>()))
            {
                Projectile.Kill();
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int d = 0; d < 25; d++)
                        {
                            ...
                            int dustIndex = Dust.NewDust(Projectile.Center, 0, 0, DustID.GreenFairy, perturbedSpeed.X, perturbedSpeed.Y, 150, default, 1f);
            ...
            Projectile.position.Y = ownerMountedCenter.Y - Projectile.height / 2 - 52;
