...
namespace StarsAbove.Projectiles.Summon.Adornment
{
    public class ChaosMagic : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            for (int d = 0; d < 8; d++)
            {
                Dust.NewDust(target.Center, 0, 0, DustID.FireworkFountain_Green, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5), 150, default, 0.7f);
                Dust.NewDust(target.Center, 0, 0, DustID.GreenFairy, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5), 150, default, 0.3f);
            ...
            {
                Projectile.velocity.X += Main.rand.Next(30, 31) * 0.01f;
            }
            if (Main.rand.NextBool(7))
            {
                Projectile.velocity.Y += Main.rand.Next(30, 31) * 0.01f;
            }
            ...
            {
                Projectile.velocity *= Main.rand.Next(1, 201) * 0.0005f;
            }
