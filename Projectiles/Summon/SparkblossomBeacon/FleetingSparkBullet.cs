    ...
    public class FleetingSparkBullet : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, DustID.Electric,
                    Projectile.velocity.X * .2f, Projectile.velocity.Y * .2f, 200, Scale: 0.4f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            for (int d = 0; d < 8; d++)
            {
                Dust.NewDust(target.Center, 0, 0, 92, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5), 150, default, 0.4f);
