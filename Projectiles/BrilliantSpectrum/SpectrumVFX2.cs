...
{
    public class SpectrumVFX2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (modPlayer.refractionGauge >= 20 && modPlayer.refractionGauge < 90 && modPlayer.BrilliantSpectrumHeld)
			{
				Lighting.AddLight(Projectile.Center, new Vector3(0.2f, 1f, 0.57f));
