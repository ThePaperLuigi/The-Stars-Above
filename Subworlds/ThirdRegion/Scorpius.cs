...
{
    public class Scorpius : Subworld
    {
        ...
        public override List<GenPass> Tasks => new List<GenPass>()
        {
            new PassLegacy("Serpens", (progress, _) =>
            {
					...
					StructureHelper.Generator.GenerateStructure("Structures/Scorpius/Scorpius1", new Terraria.DataStructures.Point16(Main.maxTilesX/2 - 200, Main.maxTilesY/2 - 80), StarsAbove.Instance);
                    StructureHelper.Generator.GenerateStructure("Structures/Scorpius/Scorpius2", new Terraria.DataStructures.Point16(Main.maxTilesX/2, Main.maxTilesY/2 - 80), StarsAbove.Instance);
        ...
        public override void OnEnter()
        {
            ...
            Main.moonPhase = 4;
            Main.LocalPlayer.GetModPlayer<CelestialCartographyPlayer>().locationName = "Scorpius";
