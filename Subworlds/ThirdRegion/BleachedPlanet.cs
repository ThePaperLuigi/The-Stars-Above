        ...
        public override List<GenPass> Tasks => new List<GenPass>()
        {
            new PassLegacy("Bleached Planet Caelum", (progress, _) =>
            {
				...
				//The player will spawn on the leftmost side of this structure below
                    ...
                    StructureHelper.Generator.GenerateStructure("Structures/BleachedWorld/BleachedWorld6", new Terraria.DataStructures.Point16(Main.maxTilesX/2 + 599, Main.maxTilesY/2 - 80), StarsAbove.Instance);
