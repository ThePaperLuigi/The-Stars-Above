...
{
    public class SeaOfStars2 : Subworld
	{
		...
		{
			new PassLegacy("The Alien Ship", (progress, _) =>
			{
				...
				StructureHelper.Generator.GenerateStructure("Structures/CrystalCave", new Terraria.DataStructures.Point16((Main.maxTilesX/2) - 70, (Main.maxTilesY/2) - 116), StarsAbove.Instance);
					...
					//StructureHelper.Generator.GenerateStructure("Structures/MarbleDebris2", new Terraria.DataStructures.Point16(Main.maxTilesX/2 - 70, Main.maxTilesY/2 - 60), StarsAbove.Instance);
