...
{
	public class GalacticMean : Subworld
	{
		...
		{
			new PassLegacy("The Galactic Mean", (progress, _) =>
			{
				...
				StructureHelper.Generator.GenerateStructure("Structures/WIPCity", new Terraria.DataStructures.Point16((Main.maxTilesX/2) - 10, (Main.maxTilesY/2) - 10), StarsAbove.Instance);
