...
{
    public class RuinedSpaceship : Subworld
	{
		...
		{
			new PassLegacy("The Ruined Spaceship", (progress, _) =>
			{
				...
				StructureHelper.Generator.GenerateStructure("Structures/SpaceshipRuins", new Terraria.DataStructures.Point16((Main.maxTilesX/2) - 100, (Main.maxTilesY/2) - 60), StarsAbove.Instance);
